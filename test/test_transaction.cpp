...
"-----END PUBLIC KEY-----\n";
  ...
  char* signature = rsa::signMessage(privateKey, plainText);
  bool authentic = rsa::verifySignature(publicKey, "My secret message.\n", signature);
  ...
  //std::cout<< " private key size " << sizeof(t_long._transaction.publickey_) << " bytes\n";
  //std::cout<< " data size " << sizeof(t_long._transaction) << " bytes\n";
  //std::cout<< " publicKey size " << sizeof(t_long._transaction) << " bytes\n";
  //std::cout<< " timestamp size " << sizeof(t_long._transaction) << " bytes\n";
  //std::cout<< " id size " << sizeof(t_long._transaction) << " bytes\n";
  //std::cout<< " signature size " << sizeof(t_long._transaction) << " bytes\n";
